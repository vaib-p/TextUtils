...
export default function About(props) {
  ...
  <div  style={props.myStyle} className="accordion-item">
    ...
    <div  style={props.myStyle} id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
  ...
  <div  style={props.myStyle} className="accordion-item">
    ...
    <div  style={props.myStyle} id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div  style={props.myStyle} className="accordion-body">
  ...
  <div style={props.myStyle} className="accordion-item">
    ...
    <div style={props.myStyle} id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
